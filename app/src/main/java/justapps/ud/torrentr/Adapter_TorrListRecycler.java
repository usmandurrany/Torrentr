...
public class Adapter_TorrListRecycler extends RecyclerView.Adapter<Adapter_TorrListRecycler.ViewHolder> {
    ...
    public Adapter_TorrListRecycler.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).
                inflate(R.layout.torr_list, viewGroup, false);
...
// Get the data model based on position
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent TorrDetail = new Intent(context, Activity_TorrentrDetails.class);
    ...
    private ArrayList<Model_TorrentDetail> modeltorrents;
    // Store the context for later use
    private Context context;

    // Pass in the context and users array into the constructor
    public Adapter_TorrListRecycler(Context context, ArrayList<Model_TorrentDetail> Model_TorrentDetail) {
        this.modeltorrents = Model_TorrentDetail;
